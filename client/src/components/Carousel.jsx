    ...
    return (
        <div id={`image${id}`} className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-indicators" style={{zIndex: 1}}>
                {
                    ...
                    <button type="button" key={index} data-bs-target={`#image${id}`} 
            ...
            
            {
                images.length > 1 &&
                <>
                    <button className="carousel-control-prev" data-bs-target={`#image${id}`} type="button" data-bs-slide="prev"
                    style={{width: '5%'}}>
                        <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span className="visually-hidden">Previous</span>
                    </button>

                    <button className="carousel-control-next" data-bs-target={`#image${id}`} type="button" data-bs-slide="next"
                    style={{width: '5%'}}>
